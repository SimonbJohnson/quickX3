...
'type':'chart',
'subType':'row',
'ingredients':[{'name':'what','tags':['#activity-code-id-url','#sector-code-id']},{'name':'value','tags':['#value','#affected','#population','#reached','#targeted','#inneed','#indicator+value']}],
'criteria':['what > 1', 'what < 11'],
...
'type':'chart',
'subType':'row',
'ingredients':[{'name':'where','tags':['#country-code','#region-code','#adm1-code','#adm2-code','#adm3-code','#adm4-code','#loc-code']},{'name':'value','tags':['#value','#affected','#population','#reached','#targeted','#inneed','#indicator+value','#capacity']}],
...
//#indicator, #severity, #status, #event, #modality, #channel, #item
...
'type':'chart',
'subType':'row',
'ingredients':[{'name':'indicator','tags':['#indicator-value-pct','#severity','#status','#event','#modality','#channel','#crisis','#respondee','#item-unit-code']},{'name':'value','tags':['#value','#affected','#population','#reached','#indicator+value']}],
