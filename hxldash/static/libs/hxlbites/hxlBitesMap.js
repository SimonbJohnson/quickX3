...
hxlBites._mapValues = {'world':[
	...
	'cod':[
		...
		{'iso3':'LBR', 'iso2':'LY', 'use':'LY', 'url':'/static/geoms/topojson/{{country}}/{{level}}/geom.json','adjustment':0,'code_att':'admin{{level}}Pcode','name_att':'admin{{level}}Name','levels':[1,2]},
		{'iso3':'LBY', 'iso2':'LR', 'use':'LR', 'url':'/static/geoms/topojson/{{country}}/{{level}}/geom.json','adjustment':0,'code_att':'admin{{level}}Pcode','name_att':'admin{{level}}Name','levels':[1,2]},
